...
pub fn build_toolbar() -> (gtk::Box, ToolbarWidgets) {
    ...
    for lang in crate::wysiwyg::CODE_LANGUAGES {
    ...
    let mode_btn = gtk::Button::with_label("MD");
    mode_btn.set_tooltip_text(Some("Toggle source mode"));
    mode_btn.add_css_class("toolbar-pill");
